...
public class BlockEntityCapabilityProxyConfig<M extends IModBase> extends BlockConfigCommon<M> {
    ...
    public BlockEntityCapabilityProxyConfig(M mod, BiFunction<BlockPos, BlockState, ? extends CyclopsBlockEntity> blockEntitySupplier) {
        super(
                mod,
                "entity_capability_proxy",
                (eConfig, properties) -> new BlockEntityCapabilityProxy(properties
