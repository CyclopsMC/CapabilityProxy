...
public class BlockCapabilityProxyConfig<M extends IModBase> extends BlockConfigCommon<M> {
    ...
    public BlockCapabilityProxyConfig(M mod, BiFunction<BlockPos, BlockState, ? extends CyclopsBlockEntity> blockEntitySupplier) {
        super(
                mod,
                "capability_proxy",
                (eConfig, properties) -> new BlockCapabilityProxy(properties
