...
public class BlockRangedCapabilityProxyConfig<M extends IModBase> extends BlockConfigCommon<M> {
    ...
    public BlockRangedCapabilityProxyConfig(M mod, BiFunction<BlockPos, BlockState, ? extends CyclopsBlockEntity> blockEntitySupplier) {
        super(
                mod,
                "ranged_capability_proxy",
                (eConfig, properties) -> new BlockRangedCapabilityProxy(properties
