 ...
 * @author rubensworks
 */
public class BlockEntityRangedCapabilityProxyForge extends BlockEntityCapabilityProxyForge {

    public BlockEntityRangedCapabilityProxyForge(BlockPos blockPos, BlockState blockState) {
